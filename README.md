...
`onetest-gh` MCP server driven by the [`web-qa`](https://github.com/arozumenko/sdlc-skills/tree/main/bundles/web-qa)
agent family.
...
- **[`docs/`](docs/)** — the full reference.
  ...
  - [`docs/github-native/`](docs/github-native/) — the GitHub-native target: topology, per-domain
    ...
    [`onetest-gh` MCP spec](docs/github-native/onetest-gh-mcp-spec.md),
...
2. The `onetest-gh` npx package (stdio MCP + CLI) per the spec.
