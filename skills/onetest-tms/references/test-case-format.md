...
| `type` | yes | `functional` \| `regression` \| `smoke` \| `integration` \| `exploratory` | |
...
| `requirements` | no | list of strings | Traceability (e.g. `REQ-010`). |
| `tags` | no | list of strings | Free-form labels used for search and run scoping. |
